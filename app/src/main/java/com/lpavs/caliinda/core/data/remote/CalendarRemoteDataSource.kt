    ...
    suspend fun updateEvent(
        ...
        return safeApiCall {
            ...
            if (response.isSuccessful) {
                ...
                Log.e(TAG, "updateEvent failed: ${response.code()}, errorBody: ${response.errorBody()?.string()}")
    ...
    suspend fun deleteEvent(eventId: String, mode: EventDeleteMode): Result<Unit> {
        ...
        return safeApiCall {
            ...
            if (response.isSuccessful) {
                ...
                Log.e(TAG, "deleteEvent failed: ${response.code()}, errorBody: ${response.errorBody()?.string()}")
                throw ApiException(response.code(), response.errorBody()?.string())
            }
        }
    }
