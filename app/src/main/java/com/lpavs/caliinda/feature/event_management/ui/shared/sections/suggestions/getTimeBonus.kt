...
fun getTimeBasedBonus(chipKey: String, time: LocalTime): Int {
    ...
    val dayP2 = setOf("lunch", "call", "errand", "appointment", "project", "presentation", "study", "shopping")
    val eveningP2 = setOf("relax", "movie", "date", "party", "cooking", "walking", "hobby", "gym", "reading", "pet", "call")
